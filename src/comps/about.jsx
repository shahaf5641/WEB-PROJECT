    ...
    <div className="container mx-auto py-10">
      <div className="bg-white p-8 rounded-lg shadow-lg">
        ...
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl font-bold mb-4 font-serif bg-slate-600 text-white p-4 rounded">Welcome to our website!</h1>
          ...
          <h2 className="text-2xl font-bold mb-3 bg-slate-600 text-white p-2 rounded">Our Mission</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-bold mb-3 bg-slate-600 text-white p-2 rounded">Our Team</h2>
